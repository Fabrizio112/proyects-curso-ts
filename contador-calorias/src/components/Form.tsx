import { ChangeEvent, FormEvent, useMemo, useState,Dispatch, useEffect } from "react";
import type { ContadorCalorias } from "../types";
import { ContadorCaloriasActions, ContadorCaloriasState } from "../reducer/contadorCaloriasReducer";
import {v4 as uuidv4} from "uuid"

type FormularioProps={
    dispatch:Dispatch<ContadorCaloriasActions>
