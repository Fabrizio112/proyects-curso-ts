...
import { ContadorCaloriasActions } from "../reducer/contadorCaloriasReducer";

type ContadorListProps={
    activities:ContadorCalorias[]
    dispatch:Dispatch<ContadorCaloriasActions>
}

function ContadorCaloriasList({activities,dispatch}:ContadorListProps) {
