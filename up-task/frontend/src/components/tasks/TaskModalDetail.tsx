...
export default function TaskModalDetails() {
    ...
    const viewTask = querySearch.get("viewTask")!
    ...
    const handleChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        mutate({ projectId, taskId: viewTask, status: e.target.value as TaskStatus })
    }

    if (data) return (
        <>
            <Transition appear show={viewTask ? true : false} as={Fragment}>
